...
export default function AdminFinances() {
  ...
  useEffect(() => {
    fetchData();
  }, [userTypeFilter, withdrawalStatusFilter]);
  ...
  const fetchSummary = async () => {
    const { data: balanceData } = await supabase
      .from("user_balances")
      .select("credits_available, earnings_available, escrow_held");
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">{formatMoney(summary.total_earnings, "USD")}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">{formatMoney(summary.total_escrow, "USD")}</div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {formatMoney(summary.pending_withdrawal_amount, "USD")} total
              </p>
            </CardContent>
          </Card>
                  ...
                  {filteredBalances.map((balance) => (
                    <TableRow key={balance.id}>
                      ...
                      <TableCell className="text-right font-mono text-green-600">
                        {formatMoney(Number(balance.earnings_available), "USD")}
                      </TableCell>
                      <TableCell className="text-right font-mono text-blue-600">
                        {formatMoney(Number(balance.escrow_held), "USD")}
                      </TableCell>
            ...
            <DialogDescription>
              {processingWithdrawal && (
                <div className="mt-2 space-y-2">
                  ...
                  <p><strong>Valor:</strong> {formatMoney(Number(processingWithdrawal.amount), processingWithdrawal.currency)}</p>
