...
const PERMISSION_LABELS: Record<string, { label: string; description: string }> = {
  ...
  can_manage_tracking_pixels: { label: "Pixels de Rastreamento", description: "Gerenciar Facebook Pixel, Google Analytics e GTM" },
...
const DEFAULT_PERMISSIONS: Partial<AdminPermissions> = {
  ...
  can_manage_tracking_pixels: false,
...
export default function AdminManagement() {
  ...
  const openEditDialog = (admin: (typeof admins)[0]) => {
    ...
    setNewPermissions({
      ...
      can_manage_tracking_pixels: (admin as any).can_manage_tracking_pixels || false,
